# Customer Churn Analysis & Strategy Simulation
...
├── 02_EDA.ipynb                                # 이탈/유지 고객 분포 및 고객 현황 분석 
├── 03_rule_extraction.ipynb                    # 결정 트리 모델을 통해 규칙 추출
├── 04_sensitivity_analysis.ipynb               # 민감도 분석 
│
└── dataset/  
     ├── BankChurners.csv
